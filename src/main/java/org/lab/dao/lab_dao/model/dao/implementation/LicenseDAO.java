...
public class LicenseDAO implements GenericDAO<License> {
    ...
    private static final String GET_ALL = "SELECT * FROM third_lab_db.license";
    private static final String GET_ONE = "SELECT * FROM third_lab_db.license WHERE id=?";
    private static final String CREATE = "INSERT third_lab_db.license "
            + "(date_of_issue,  place_of_issue) VALUES (?, ?)";
    private static final String UPDATE = "UPDATE third_lab_db.license"
            + " SET date_of_issue=?, place_of_issue=? WHERE id=?";
    private static final String DELETE = "DELETE FROM third_lab_db.license WHERE id=?";
    ...
    public void create(License license) throws SQLException {
        ...
        try (PreparedStatement statement = DatabaseConnector.getConnection().prepareStatement(CREATE)) {
            ...
            statement.setInt(1, license.getId());
            statement.setString(2, license.getDateOfIssue());
            statement.setString(3, license.getPlaceOfIssue());
