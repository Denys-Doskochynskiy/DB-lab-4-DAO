...
public class AutoDAO implements GenericDAO<Auto> {
    ...
    private static final String GET_ALL = "SELECT * FROM third_lab_db.auto";
    private static final String GET_ONE = "SELECT * FROM third_lab_db.auto WHERE id=?";
    private static final String CREATE = "INSERT third_lab_db.auto "
            + "(mark, auto_number, auto_type, state) VALUES (?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE third_lab_db.auto"
            + " SET mark=?, auto_number=?, auto_type=?, state=? WHERE id=?";
    private static final String DELETE = "DELETE FROM third_lab_db.auto WHERE id=?";
